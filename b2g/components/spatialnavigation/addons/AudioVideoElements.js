...
/**
 * This works for <audio> and <video> elements those have XUL elements to
 * control media.
 *
 *  When currently focused element in DOM tree is <audio> or <video>, there're
 * some focusable element inside of them no matter how it's visible on DOM tree
 * or not. This will works on such a case to move "internal" focus inside of
 * them.
 */
