...
/**
 * Register domain "resource://spatialnavigation" and inject Loader.js into
 * processes.
 *
...
////////////////////////////////////////////////////////////////////////////////
// Register domain resource://spatialnavigation
...
if (processType === Ci.nsIXULRuntime.PROCESS_TYPE_DEFAULT) {
  const chromeWindow = Cu.import(`resource://${kModuleName}/DOMInfo.jsm`)
                         .DOMInfo
