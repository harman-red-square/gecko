...
/**
 * PrefObserver observes preference under "snav." and emits event when there's
 * change.
 *
 * Ex1) Getting value from preference "snav.enabled"
 *   - PrefObserver["enabled"]
 * Ex2) Watching value from preference unser "snav.enabled"
 *   - PrefObserver.on("enabled", (aKind, aVal) => ...)
 */
