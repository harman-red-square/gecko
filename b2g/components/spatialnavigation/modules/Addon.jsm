...
/**
 * There's some addons for better UX and functionalities under
 * resource://spatialnavigation/addons/
 *
 * They're loaded by Addon module as sandbox. Addon also offers global objects
 * for each sandboxes. The global objects contains some functions to control
 ...
 *-----------------------------------------------------------------------------
 * userinput  : function (aKind, aKey)
 * toremote   : function (aKind, aMozBrowserFrame)
 * preaction  : function (aKind, aTargetElem)
 * postaction : function (aKind, aTargetElem)
 * premove    : function (aKind, aFocusedElem, aDirection)
 * postmove   : function (aKind, aElemJustMoved, aDirection, aElemPreFocused)
 * prefocus   : function (aKind, aElemToFocus)
 * postfocus  : function (aKind, aElemJustFocused)
 * prescroll  : function (aKind, aElemToBeScrolled, dx, dy)
 * postscroll : function (aKind, aElemJustScrolled, dx, dy)
 ******************************************************************************/
