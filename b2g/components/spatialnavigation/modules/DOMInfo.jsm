...
/**
 * DOMInfo used to get information from DOM tree.
 * The information is retrieved from a node in DOM tree or DOM tree itself.
 *
 * When getting information from a node it'll used like below
 *  DOMInfo(*node*).getBoundingRect()
 * or when from DOM tree it self
